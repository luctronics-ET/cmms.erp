...
_XPREDIAL_FRONTEND_DIR = os.path.join(_FRONTEND_DIR, "predial")
_PAIOL_FRONTEND_DIR = os.path.join(_FRONTEND_DIR, "paiol")
...
app.mount("/predial", StaticFiles(directory=_XPREDIAL_FRONTEND_DIR), name="predial")
app.mount("/paiol", StaticFiles(directory=_PAIOL_FRONTEND_DIR), name="paiol")


@app.get("/")
async def root():
    return FileResponse(os.path.join(_FRONTEND_DIR, "cmasm-erp.html"))
