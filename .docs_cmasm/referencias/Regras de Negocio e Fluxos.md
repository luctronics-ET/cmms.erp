...
**Fonte canônica do modelo de domínio do xCMASM.** Cópia espelhada em `pmoc.refs/Regras de Negócio e Fluxos.md` para referência junto às demais fontes operacionais.
